...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x020002e0, ; uint32_t android_runtime_jnienv_class_token
	i32 u0x06001b70, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001b6f, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [774 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x0645c4b6f422c395, ; from name: aot-ChessMAUI.so
		i64 u0x8462ce38ddcea99c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessMAUI.dll.so
		ptr null; void* handle
	}, ; 18
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x3fc473710bb6c0ac, ; from name: libaot-ChessMAUI.so
		i64 u0x8462ce38ddcea99c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessMAUI.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x44360fb92a8fe7c5, ; from name: ChessMAUI.so
		i64 u0x8462ce38ddcea99c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessMAUI.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x64aea8342ff2ab24, ; from name: libaot-ChessMAUI
		i64 u0x8462ce38ddcea99c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessMAUI.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x7a43e1765551a5aa, ; from name: aot-ChessMAUI.dll.so
		i64 u0x8462ce38ddcea99c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessMAUI.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8462ce38ddcea99c, ; from name: libaot-ChessMAUI.dll.so
		i64 u0x8462ce38ddcea99c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessMAUI.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb23a8348a579e395, ; from name: aot-ChessMAUI
		i64 u0x8462ce38ddcea99c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessMAUI.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xea42f14d76081419, ; from name: ChessMAUI.dll.so
		i64 u0x8462ce38ddcea99c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessMAUI.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf857b67c3c41dd09, ; from name: ChessMAUI
		i64 u0x8462ce38ddcea99c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChessMAUI.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [20 x i8] c"com.chess.chessmaui\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [24 x i8] c"libaot-ChessMAUI.dll.so\00", align 16
